...
description: >-
  paton.ch sets no cookies. No analytics, no tracking, no advertising — and therefore no
  consent banner.
updated: 2026-09-05
---
...
paton.ch is a static site. It stores nothing in your browser: no cookies, no local storage, no
session storage, no fingerprinting, and no identifiers of any kind — not even "essential" ones,
because there is no login, no basket and no session to keep.

That is why you were not shown a consent banner. A banner would be asking you to agree to nothing.
...
consent-management plugin. The site was rebuilt from scratch in 2026 and none of that was carried
over. Any cookies those older versions left in your browser are no longer set or read by this site;
clearing your browser's site data for paton.ch removes them.
